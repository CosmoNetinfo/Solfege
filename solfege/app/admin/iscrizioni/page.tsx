...
export default function IscrizioniWebPage() {
  ...
  // 2. Recupera le iscrizioni pendenti direttamente da Supabase
  const fetchRegistrations = async () => {
    ...
    try {
      ...
      toast.error("Impossibile caricare le iscrizioni: " + err.message);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleApprove = async (reg: any) => {
    ...
    try {
      ...
      // Aggiorna lo stato direttamente su Supabase
